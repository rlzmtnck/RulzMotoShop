...
func (_m *Service) Login(email string, password string) (sellers.Domain, error) {
...
func (_m *Service) Register(domain *sellers.Domain) (sellers.Domain, error) {
...
func (_m *Service) SellerByID(id int) (sellers.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Service) Update(sellID int, domain *sellers.Domain) (sellers.Domain, error) {
